...
MONITOR0 = "-g 1024x768+0+0"  # to run on primary monitor
MONITOR1 = "-g 1024x768+1024+0"  # to run on secondary monitor
...
def grep():
    ...
    try:
        ...
        return "https://sys.4chan.org/image/error/404/rid.php"
